...
async function sendTicketMail(email, name, event, ticketFile) {
  ...
  const transporter = nodemailer.createTransport({
    host: "smtp.gmail.com",
    port: 587,            // Use 587 instead of 465 (many hosting providers block 465)
    secure: false,        // false for 587 (uses STARTTLS automatically)
    ...
    connectionTimeout: 10000, // Increased timeout to 10s
    greetingTimeout: 10000,
    socketTimeout: 10000,
    family: 4             // Force IPv4, prevents ENETUNREACH on servers without valid IPv6 routing
  });
